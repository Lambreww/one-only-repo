...
// 3D модел на вратата
function DoorModel({ color, materialType, wicketDoor }) {
...
function Door3DViewer({ color, material, wicketDoor }) {
...
function DoorVisualization({ doorType, color, material, wicketDoor }) {
    ...
    <div className="dc-visualization-container">
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          ...
          <span style={{ color: '#9CA3AF', fontSize: '0.875rem' }}>Проходна врата</span>
        </div>
      </div>
    </div>
  );
    ...
    <div className="dc-premium-container">
      <div className="dc-premium-grid">
        ...
        <div className="dc-control-panel">
          ...
          <div className="dc-section-premium">
            <div className="dc-options-grid" style={{ gridTemplateColumns: '1fr' }}>
              {/* Проходна врата */}
